"""mutant_05: violates SPEC 3.2 -- missing predictions silently skipped instead of counted as FN.
Killing input: omit one gold example from predictions -> its category F1 too high
