"""mutant_14: violates SPEC 2.3 -- startswith alias matching instead of exact whole-string.
Killing input: "payment issue" wrongly maps to billing; ref treats it as INVALID
