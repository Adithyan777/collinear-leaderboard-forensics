"""mutant_04: violates SPEC 3.1/4.1 -- invalid predictions also counted as FP against the gold category.
Killing input: gold billing x2, one junk + one correct -> billing fp=1 shifts f1 (2/3 -> 0.5)
