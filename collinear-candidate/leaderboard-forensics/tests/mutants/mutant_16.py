"""[EXCLUDED FROM GRADING - blind-reachability rule] mutant_16: violates SPEC 7.1 -- always rounds the overall UP (ceiling at 4dp) instead of ROUND_HALF_UP.
Killing input: the SPEC 9 example 0.86665 -> 0.8667 PASSES this mutant; killing needs an overall that must round DOWN, e.g. overall = 1/3 -> 0.3333 (ceiling gives 0.3334)
