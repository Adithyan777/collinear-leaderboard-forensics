"""mutant_12: violates SPEC 2.1 -- collapses ASCII space runs only; other Unicode whitespace not treated as whitespace.
Killing input: "sign\u00a0in" (NBSP) or "sign\tin" fails to normalize -> INVALID instead of account_access
...
def normalize_label(raw):
    ...
    s = " ".join(p for p in s.lower().split(" ") if p)
