"""mutant_07: violates SPEC 3.4 -- rows with unknown example_ids counted as FPs.
Killing input: stray row with unknown id and valid label -> spurious FP
