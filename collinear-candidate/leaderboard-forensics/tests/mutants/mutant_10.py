"""mutant_10: violates SPEC 7.1 -- banker's rounding (built-in round) instead of ROUND_HALF_UP.
Killing input: overall landing on a .xxxx5 boundary rounds down instead of up
