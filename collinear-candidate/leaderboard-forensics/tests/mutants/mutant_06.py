"""mutant_06: violates SPEC 3.3 -- last duplicate occurrence wins instead of first.
Killing input: same example twice: correct then wrong -> mutant scores the wrong one
