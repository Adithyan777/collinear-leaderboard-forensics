...
from pipeline.data_io import connect, insert_rows, read_jsonl, reset_db
...
def run(resume=False, log=print):
    ...
    for shard in plan:
        ...
        # idempotent: a crash between commit and mark_done leaves committed
        # rows for a shard the plan will re-score; clear them first
